...
export const BRAWLER_LORE: Record<string, string> = {
  ...
  kibo:  "Кибо был лучшим выпускником академии плазменных стрелков. Он отказался служить корпорации и сбежал, прихватив прототип винтовки. Теперь он странствующий снайпер, который сражается за слабых и никогда не делится своей настоящей фамилией.",
