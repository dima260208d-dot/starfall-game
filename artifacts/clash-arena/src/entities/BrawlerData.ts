...
export const BRAWLERS: BrawlerStats[] = [
  ...
  },
  {
    ...
    attackDesc: "Мгновенный плазменный луч дальностью 550, наносит 320 урона первой цели.",
    superDesc: "Длинный пронзающий луч на всю карту, проходит сквозь врагов и наносит каждому по 900 урона.",
    spriteRow: 0,
    spriteCol: 1,
  },
  {
